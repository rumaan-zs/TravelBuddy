    ...
    public void onBindViewHolder(@NonNull CheckListViewHolder holder, int position) {
        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                database.mainDao().checkUnchech(itemsList.get(position).getID(), check);
                if (MyConstants.FALSE_STRING.equals(show)) {
                    ...
                    if (itemsList.get(position).getChecked()) {
                        toastMessage = Toast.makeText(context, "(" + holder.checkBox.getText() + ") Item Packed", Toast.LENGTH_SHORT);
                    } else {
                        toastMessage = Toast.makeText(context, "(" + holder.checkBox.getText() + ") Item Unpacked", Toast.LENGTH_SHORT);
                    }
                    toastMessage.show();
                }
