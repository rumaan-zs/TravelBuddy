...
import com.example.travelbuddy.Dao.ItemsDao_Impl;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `items` (`ID` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `itemname` TEXT, `category` TEXT, `addedby` TEXT, `checked` INTEGER)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '28ad3a61217dd57f68552ae77cd4fd29')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsItems.put("checked", new TableInfo.Column("checked", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoItems.equals(_existingItems)) {
          return new RoomOpenHelper.ValidationResult(false, "items(com.example.travelbuddy.Models.Items).\n"
                  + " Expected:\n" + _infoItems + "\n"
                  + " Found:\n" + _existingItems);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "28ad3a61217dd57f68552ae77cd4fd29", "b82475330c2caacae60d9d5c9eedb789");
